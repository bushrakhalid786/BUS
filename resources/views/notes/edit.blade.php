...
<div class="span6">
 ...
 {!! Form::model($note, ['class'=>'form-horizontal', 'name' => 'basic_validate', 'id' => 'basic_validate', 'novalidate' => '', 'route' => ['notes.update', $note->note_id], 'method' => 'PUT']) !!}
    ...
    <div class="control-group">
      {{ Form::label('account_id','Account ID', array('class' => 'control-label'))}}
         <div class="controls">
            <!-- {{ Form::text('account_id', null, array('class' => 'span11')) }} -->
...
{!! Html::linkRoute('notes.index', 'Cancel', array(), array('class' => 'btn btn-danger')) !!} 
